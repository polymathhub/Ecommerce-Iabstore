      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <m.div variants={itemVariants} className="text-center md:text-left">
            ...
            >
              <p className="text-sm">
                DISCLAIMER: This website is a learning project. IABtechstore is created for educational and skill development purposes. While realistic, this is a demonstration platform for e-commerce best practices.
              </p>
        ...
        >
          <p>© {new Date().getFullYear()} IABtechstore. All rights reserved.</p>
          <m.div 
